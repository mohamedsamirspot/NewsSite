...
namespace NewsSite.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var name = await _db.ApplicationUser.FirstOrDefaultAsync(o => o.Id == claim.Value);
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.Name != applicationUser.Name)
            {
                ...
                {
                        var userId = await _userManager.GetUserIdAsync(user);
                        throw new InvalidOperationException($"Unexpected error occurred setting the name for user with ID '{userId}'.");
                }
